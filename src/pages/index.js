    ...
    <div className={styles['container']}>
      ...
      <div className={styles['section1']}>
        <div className={styles['container03']}>
          <div className={styles['container04']}>
            ...
            <span
              className={` ${styles['text08']} ${projectStyles['text-x-l']} `}
            >
          ...
          <div className={styles['cards-container']}>
            <div className={styles['card1']}>
              ...
              <h6
                className={` ${styles['text10']} ${projectStyles['text-x-l']} `}
              >
                Awarded Agency
              </h6>
            ...
            <div className={styles['card2']}>
              ...
              <h6
                className={` ${styles['text12']} ${projectStyles['text-x-l']} `}
              >
                Free Revisions
              </h6>
            ...
            <div className={styles['card3']}>
              ...
              <h6
                className={` ${styles['text14']} ${projectStyles['text-x-l']} `}
              >
                Verified Company
              </h6>
      ...
      <div className={styles['section2']}>
        <div className={styles['container13']}>
          ...
          <h2 className={` ${styles['text27']} ${projectStyles['text2x-l']} `}>
          ...
          <span
            className={` ${styles['text29']} ${projectStyles['text-x-l']} `}
          >
        ...
        <div className={styles['container22']}>
          ...
          <span
            className={` ${styles['text38']} ${projectStyles['text-x-l']} `}
          >
      ...
      <div className={styles['section3']}>
        <div className={styles['container44']}>
          <h6 className={` ${styles['text40']} ${projectStyles['text-s-m']} `}>
          ...
          <span
            className={` ${styles['text43']} ${projectStyles['text-x-l']} `}
          >
          ...
          <div className={styles['services']}>
            ...
            <div className={styles['container45']}>
              ...
              <h1
                className={` ${styles['text45']} ${projectStyles['text-x-l']} `}
              >
                Grow your market
              </h1>
            ...
            <div className={styles['container47']}>
              ...
              <h1
                className={` ${styles['text47']} ${projectStyles['text-x-l']} `}
              >
                Launch time
              </h1>
          ...
          <div className={styles['contact']}>
            ...
            <span
              className={` ${styles['text50']} ${projectStyles['text-x-l']} `}
            >
            ...
            <div className={styles['form']}>
              ...
              <span
                className={` ${styles['text52']} ${projectStyles['text-x-l']} `}
              >
                Complete this form and we will get back to you in 24 hours.
              </span>
              <span
                className={` ${styles['text53']} ${projectStyles['text-x-s']} `}
              >
                FULL NAME
              </span>
              <input
                ...
                className={` ${styles['textinput']} ${projectStyles['text-s-m']} ${projectStyles['input']} `}
              />
              <span
                className={` ${styles['text54']} ${projectStyles['text-x-s']} `}
              >
                EMAIL
              </span>
              <input
                type="text"
                placeholder="Email"
                className={` ${styles['textinput1']} ${projectStyles['text-s-m']} ${projectStyles['input']} `}
              />
              <span
                className={` ${styles['text55']} ${projectStyles['text-x-s']} `}
              >
                MESSAGE
              </span>
              <textarea
                ...
                className={` ${styles['textarea']} ${projectStyles['text-s-m']} ${projectStyles['textarea']} `}
              ></textarea>
